...
public class EditProductJDialog extends JDialog {
    ...
    public EditProductJDialog(ActionListener actionListener) {
        this.actionListener = actionListener;
        this.constraints = new GridBagConstraints();
        setSize(new Dimension(Constants.WIDTH_DIALOG, Constants.HEIGHT_DIALOG));
        setTitle(Constants.EDIT_PRODUCT_DIALOG_TITLE);
    ...
    public void initComponents(ActionListener actionListener) {
        ...
        add = addJButton(add, Constants.EDIT_PRODUCT_BTN, Commands.EDIT_PRODUCT_DIALOG.name(), actionListener, 0, 14, 50, 32);
    ...
    public void setFirstPrice(String firstPrice) {
        this.firstPrice.setText(firstPrice);
    }
    ...
    public void setSecondPrice(String secondPrice) {
        this.secondPrice.setText(secondPrice);
    }
    ...
    public void setThirdPrice(String thirdPrice) {
        this.thirdPrice.setText(thirdPrice);
    }
